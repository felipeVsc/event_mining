...
class EngineDuck:
    ...
    def registerAllMlFunctions(self):
        ...
        self.con.create_function("CLUSTER_KMEANS", lambda x: self.ml.cluster_kmeans(x), [float], int, type="arrow") # Maybe this wont work
    ...
    def registerAllVisualizeFunctions(self):
        ...
        self.con.create_function("SCATTER", lambda x, y: self.vis.scatter(x, y), [float,float], float, type="arrow") #Blob Maybe??
